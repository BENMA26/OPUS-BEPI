...
trainset=PDB_esm(mode='train',fold=args.fold,root=root)
valset=PDB_esm(mode='val',fold=args.fold,root=root)
testset=PDB_esm(mode='test',fold=args.fold,root=root)
