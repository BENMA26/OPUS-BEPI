...
from dataset import PDB,PDB_foldseek,PDB_foldseek_tokens,collate_fn,chain
...
trainset=PDB_foldseek(mode='train',fold=args.fold,root=root)
valset=PDB_foldseek(mode='val',fold=args.fold,root=root)
testset=PDB_foldseek(mode='test',fold=args.fold,root=root)
...
model=GraphBepi(
    feat_dim=2686,                     # esm2 representation dim
