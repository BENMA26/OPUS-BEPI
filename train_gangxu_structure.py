...
trainset=PDB_structure(mode='train',fold=args.fold,root=root,sub_dir=args.sub_dir)
valset=PDB_structure(mode='val',fold=args.fold,root=root,sub_dir=args.sub_dir)
testset=PDB_structure(mode='test',fold=args.fold,root=root,sub_dir=args.sub_dir)
...
model=GraphBepi(
    feat_dim=640,                      # esm2 representation dim
