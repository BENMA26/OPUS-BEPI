...
from dataset import PDB,PDB_foldseek,PDB_esm_if,collate_fn,chain
...
trainset=PDB_esm_if(mode='train',fold=args.fold,root=root)
valset=PDB_esm_if(mode='val',fold=args.fold,root=root)
testset=PDB_esm_if(mode='test',fold=args.fold,root=root)
...
model=GraphBepi(
    feat_dim=2560+512,                     # esm2 representation dim
