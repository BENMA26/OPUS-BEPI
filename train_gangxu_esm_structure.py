...
from dataset import PDB_esm,PDB_saport,PDB_structure,PDB_esm_structure,collate_fn,chain
...
parser.add_argument('--sub_dir', type=str, default='BCE_633', help='dataset name.')
...
trainset=PDB_esm_structure(mode='train',fold=args.fold,root=root,sub_dir=args.sub_dir)
valset=PDB_esm_structure(mode='val',fold=args.fold,root=root,sub_dir=args.sub_dir)
testset=PDB_esm_structure(mode='test',fold=args.fold,root=root,sub_dir=args.sub_dir)
...
model=GraphBepi(
    feat_dim=2560+640,                     # esm2 representation dim
