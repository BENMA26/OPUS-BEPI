...
from dataset import PDB,PDB_foldseek,PDB_esm_if,collate_fn,chain,PDB_esm_if_foldseek_tokens
...
trainset=PDB_esm_if_foldseek_tokens(mode='train',fold=args.fold,root=root)
valset=PDB_esm_if_foldseek_tokens(mode='val',fold=args.fold,root=root)
testset=PDB_esm_if_foldseek_tokens(mode='test',fold=args.fold,root=root)
...
model=GraphBepi(
    feat_dim=2560+512+21,                     # esm2 representation dim
