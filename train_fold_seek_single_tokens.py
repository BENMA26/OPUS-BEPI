...
from dataset import PDB,PDB_foldseek,PDB_foldseek_tokens,collate_fn,chain,PDB_foldseek_local_golbal
...
trainset=PDB_foldseek_local_golbal(mode='train',fold=args.fold,root=root)
valset=PDB_foldseek_local_golbal(mode='val',fold=args.fold,root=root)
testset=PDB_foldseek_local_golbal(mode='test',fold=args.fold,root=root)
...
model=GraphBepi(
    feat_dim=2581+21,                     # esm2 representation dim
