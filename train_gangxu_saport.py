...
trainset=PDB_saport(mode='train',fold=args.fold,root=root)
valset=PDB_saport(mode='val',fold=args.fold,root=root)
testset=PDB_saport(mode='test',fold=args.fold,root=root)
...
model=GraphBepi(
    feat_dim=446,                     # esm2 representation dim
