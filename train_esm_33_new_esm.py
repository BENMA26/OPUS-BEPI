...
from dataset import PDB_token_esm,PDB,PDB_foldseek,collate_fn,chain
...
trainset=PDB_token_esm(mode='train',fold=args.fold,root=root)
valset=PDB_token_esm(mode='val',fold=args.fold,root=root)
testset=PDB_token_esm(mode='test',fold=args.fold,root=root)
